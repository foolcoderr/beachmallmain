...
DROP TABLE IF EXISTS `noticeboard_noticeboard`;
...
LOCK TABLES `noticeboard_noticeboard` WRITE;
/*!40000 ALTER TABLE `noticeboard_noticeboard` DISABLE KEYS */;
/*!40000 ALTER TABLE `noticeboard_noticeboard` ENABLE KEYS */;
UNLOCK TABLES;
