...
CREATE TABLE `survey_survey` (
  `survey_idx` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `survey_survey` VALUES (1,'나는 단체 활동보다는  일대일 대화가 좋다','예','아니요','나는 혼자 있는 게 좋다.','예','아니요','나는 위험을 무릅쓰는 일을 그다지 좋아하지 않는다','예','아니요','나는 갈등을 싫어한다','예','아니요','나는 한꺼번에 여러 가지를 하는 걸 좋아하지 않는다','예','아니요','y');
...
-- Dump completed on 2022-10-27 17:10:10
