...
# 비치몰 협업 필터링
wishlist = pd.read_csv("wishlistlog.log")
cart = pd.read_csv("log/cartlog.log")
order = pd.read.csv("log/orderlog.log")

most_select_products = pd.merge(wishlist, cart, order, on="productsName")
print(most_select_products.head())
